...
func transactionReceiptHandler(w http.ResponseWriter, r *http.Request, m *Service) {
	...
	jsonReceipt := JsonReceipt{
		...
		From:              from,
		To:                tx.To(),
		GasUsed:           big.NewInt(0).SetUint64(receipt.GasUsed),           // NICOLAE_FIX: receipt.GasUsed,
		CumulativeGasUsed: big.NewInt(0).SetUint64(receipt.CumulativeGasUsed), // NICOLAE_FIX: receipt.CumulativeGasUsed,
		ContractAddress:   receipt.ContractAddress,
		Logs:              receipt.Logs,
		LogsBloom:         receipt.Bloom,
		Failed:            false, // NICOLAE_FIX: receipt.Failed,
	}
...
func prepareCallMessage(args SendTxArgs, ks *keystore.KeyStore) (*ethTypes.Message, error) {
	...
	msg := ethTypes.NewMessage(args.From,
		...
		0,
		args.Value,
		args.Gas.Uint64(), // NICOLAE_FIX: args.Gas,
		args.GasPrice,
